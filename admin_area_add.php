<?php
	...
	if(isset($_POST["Add"])){
		...
		if(!empty($City) && !empty($Area)){
			...
			$query= "INSERT INTO `area`(`area`,`city_id`) VALUES ('$Area','$City')";
			
			if($con->query($query) == TRUE){
				echo "<script>location.href='admin_area_add.php';</script>";
			}
			else{
				echo "Die";
			}
		...
		<div class="container">
			...
			<div class="row team_row" style="margin-left: 16%">
				<div class="col-md-10 col-sm-4 team_col">
					<div class="team_item">
						<div class="team_body">
							<form class="form" method="post" action="admin_area_add.php" style="margin-left: 22%">
							  <div class="row" style="padding-right: 30%">
								...
								<div class="col-md-6">
									<div class="form-group ">
										...
										<input class="form-control" required="" placeholder="Area" name="Area" type="text" id="Area">
									</div>
								</div>
							  </div>
							  <div class="">
							  	<div class="form-group">
							  		<button type="submit" class="btn btn-primary" style="" name="Add">Add</button>
							        <button type="submit" class="btn btn-primary" style="" name="Delete">Delete</button>
							  	</div>
							  </div>
							</form>
						</div>
